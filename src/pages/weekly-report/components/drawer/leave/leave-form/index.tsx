...
const index = (props: ILeaveFormProps) => {
  ...
  useEffect(() => {
    if (detailAttendanceSelected?.holiday_status_id.type === 'TC' ) {
      ...
      if (detailAttendanceSelected?.holiday_status_id.type === "DXVS" || detailAttendanceSelected?.holiday_status_id.type === "DXDM") {
          setTypeLeaveValue(
            detailAttendanceSelected?.holiday_status_id.type +
              '~' +
  ...
  useEffect(() => {
    if (
      ...
      if (typeLeaveInfo[0] && typeLeaveInfo[0] === 'TC') {
        ...
        typeLeaveInfo[0] === 'B' || typeLeaveInfo[0] === 'DXVS' || typeLeaveInfo[0] === 'DXDM'))
      ) {
        form.setFieldsValue({
          leaveDay1: [
