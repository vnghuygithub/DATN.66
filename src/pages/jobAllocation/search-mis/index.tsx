...
const SearchEmployeeAllocationMis = () => {
  ...
  const [currentJob, setCurrentJob] = useState<{ label: any; value: any }[]>([]);
  useEffect(() => {
  ...
  const fieldLabels: any = [
    ...
    { Label: 'Công ty', value: 'current_company_id' },
    { Label: 'Tên nhân viên ', value: 'employee_name' },
    { Label: 'Phòng ban', value: 'current_department_id' },
    { Label: 'Chức vụ hiện tại', value: 'current_job_id' },
    { Label: 'Chức vụ mới', value: 'job_id' },
    { Label: 'Ngày bổ nhiệm', value: 'new_job_id_date' },
                ...
                {[
                  ...
                  <Select
                    ...
                    {row.name === 'approved_by' &&
                      ...
                      {
                        row.name === 'current_job_id' &&
                        currentJob.map(field => (
                          <Option key={field.value} value={field.value}>
                            {field.label}
                          </Option>
                        ))
...
export default SearchEmployeeAllocationMis;
