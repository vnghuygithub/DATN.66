...
import SelectTypeLeave from '@/pages/components/selects/SelectTypeTreeLeaveWorkLate';
...
const index = (props: ILeaveFormProps) => {
  ...
  const [typeLeaveValue, setTypeLeaveValue] = useState('DXDM~55'); // 7~1
  ...
  useEffect(() => {
    console.log('typeLeaveInfo', typeLeaveInfo);
  }, [typeLeaveInfo]);
  useEffect(() => {
    console.log('typeLeaveValue', typeLeaveValue);
  }, [typeLeaveValue]);
  const onFinish = async (formData: any) => {
    ...
    const leave_type_id = form?.getFieldValue('typeLeave');
  ...
  toDate
    ...
    (holiday_status_id ?? typeLeaveInfo[1]) &&
