...
import { type } from 'os';
import { DOMAIN_IMPORT_LEAVE_API } from '@/api/constApi';
...
const FileForm: FC<Props> = ({
    ...
    const onFinish = async () => {
        ...
        console.log(data)
        try {
            const url = DOMAIN_IMPORT_LEAVE_API.IMPORT
    ...
    const handleDownload = () => {
        fetch("https://dl.dropboxusercontent.com/scl/fi/bxpo8e26o4c4qmdecfi0x/09.2023-Theo-doi-ngay-phep-bu_mau1.xlsx?rlkey=8gpj81gmkp8wq4c7ddfac4839&dl=0")
            .then(response => response.blob())
            .then(blob => {
                const link = document.createElement("a");
                link.href = URL.createObjectURL(blob);
                link.download = "AL-CL-Template.xlsx";
                link.click();
            })
            .catch(console.error);
    }
                    ...
                    <MyForm<any>
                        ...
                        >
                            ...
                            <Upload
                                ...
                                maxCount={1}
                            >
                            <Button  style={{width: '155px'}} icon={<UploadOutlined />}>Click to Upload</Button>
                            </Upload>
